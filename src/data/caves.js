...
export const CAVES=[
  ...
  {s:"-1,-1",t:[[4,5]],room:{tiles:mr(m=>{m[RO-1][7]=T.STAIRS_UP;m[RO-1][8]=T.STAIRS_UP;m[5][7]=T.HEART_PIECE;m[3][6]=T.TORCH;m[3][9]=T.TORCH;m[7][6]=T.TORCH;m[7][9]=T.TORCH;m[4][5]=T.RUPEE;m[4][10]=T.RUPEE;m[6][5]=T.RUPEE;m[6][10]=T.RUPEE;}),enemies:[]}},
  {s:"2,-1",t:[[13,9]],room:{tiles:mr(m=>{m[RO-1][7]=T.STAIRS_UP;m[RO-1][8]=T.STAIRS_UP;m[5][7]=T.BANANA;m[3][5]=T.TORCH;m[3][10]=T.TORCH;m[7][5]=T.TORCH;m[7][10]=T.TORCH;m[4][7]=T.RUPEE;m[6][7]=T.RUPEE;m[4][8]=T.RUPEE;m[6][8]=T.RUPEE;}),enemies:[]}},
